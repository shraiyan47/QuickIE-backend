...
router.post("/api/user/registration/daily-report", async (req, res) => {
  try {
    const emailX = req.body.email;
    const naamX = req.body.naam;
    const Chabi = req.body.password;
...
// CRM Registration 
router.post("/api/user/registration/crm", async (req, res) => {
  try {
    const emailX = req.body.email;
    const naamX = req.body.naam;
    const Chabi = req.body.password;
...
router.post("/api/user/registration/inventory", async (req, res) => {
  try {
    const emailX = req.body.email;
    const naamX = req.body.naam;
    const Chabi = req.body.password;
